...
print("="*80)
print("ADDING POST /contacts/tags ROUTE")
print("="*80)

lambda_arn = f"arn:aws:lambda:{REGION}:{ACCOUNT_ID}:function:CreateContactTagLambda"
...
try:
    ...
    # Create POST route
    print("\n2. Creating POST /contacts/tags route...")
    route = apigateway.create_route(
        ApiId=API_ID,
        RouteKey='POST /contacts/tags',
    ...
    try:
        lambda_client.add_permission(
            FunctionName='CreateContactTagLambda',
            StatementId='apigateway-post-contacts-tags',
    ...
    print("\n" + "="*80)
    print("POST /contacts/tags ROUTE ADDED!")
    print("="*80)
