...
try:
    from handlers import contacts, campaigns, recipients, tags, auth, compliance, ai
...
def lambda_handler(event, context):
    ...
    try:
        ...
        elif path == '/contacts/delete' and method == 'POST':
            response = contacts.delete_contact_by_email(event, context)
        ...
        elif path == '/contacts/tags/delete' and method == 'POST':
             response = tags.delete_tag(event, context)
        ...
        # AI GENERATION
        elif path == '/ai/generate' and method == 'POST':
            response = ai.generate_content(event, context)
