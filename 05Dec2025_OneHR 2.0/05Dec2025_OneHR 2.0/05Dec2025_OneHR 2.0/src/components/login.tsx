...
import { Building2, Lock, Mail, AlertCircle, Crown, ArrowLeft, Eye, EyeOff } from 'lucide-react';
...
export function Login({ onSignupClick, onBackToLanding }: LoginProps = {}) {
  ...
  useEffect(() => {
    // 1️⃣ From query param: /login?o=org123
    const orgFromQuery = searchParams.get("o");

    // 2️⃣ From navigation state
    const orgFromState = (location.state as any)?.organizationID;

    setOrganizationID(orgFromQuery || orgFromState || null);
        ...
        <div className="w-full max-w-md space-y-6">
          <div className="text-center space-y-2">
            ...
            <h1 className="text-2xl font-semibold">
              {organizationID ? `Business Platform: ${organizationID}` : 'Business Platform'}
            </h1>
