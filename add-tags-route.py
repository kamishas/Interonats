...
print("="*80)
print("ADDING /contacts/tags ROUTE")
print("="*80)

lambda_arn = f"arn:aws:lambda:{REGION}:{ACCOUNT_ID}:function:ListContactTagsLambda"
...
try:
    ...
    # Create GET route
    print("\n2. Creating GET /contacts/tags route...")
    route = apigateway.create_route(
        ApiId=API_ID,
        RouteKey='GET /contacts/tags',
    ...
    try:
        lambda_client.add_permission(
            FunctionName='ListContactTagsLambda',
            StatementId='apigateway-get-contacts-tags',
    ...
    print("="*80)
    print(f"\nEndpoint: https://{API_ID}.execute-api.{REGION}.amazonaws.com/contacts/tags")
